...
elgg_push_collection_breadcrumbs('object', 'marketplace', $user, true);

elgg_register_title_button('marketplace', 'add', 'object', 'marketplace');

$title = elgg_echo('collection:object:marketplace:friends');
if ($lower) {
	$title .= ': ' . elgg_echo('date:month:' . date('m', $lower), [date('Y', $lower)]);
}

$content = elgg_view('marketplace/listing/friends', [
	'entity' => $user,
	'created_after' => $lower,
